...
function currentLook(): ShaderLook {
  return document.documentElement.classList.contains("dark") ? DARK_LOOK : LIGHT_LOOK;
}
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    gl.uniform3fv(uni.colors, new Float32Array(currentLook().colors.flat()));
    gl.uniform4f(
      uni.shape,
      UNIFORMS.scale,
      UNIFORMS.intensity,
    ...
    function render(now: number) {
      ...
      gl.uniform3fv(uni.colors, new Float32Array(look.colors.flat()));
      gl.uniform4f(
        uni.surface,
        UNIFORMS.detail,
        look.contrast,
