...
export function PageShell({
  ...
  return <div className={cn("flex flex-col gap-5", className ?? "min-h-full")}>{children}</div>;
}
...
export function PageHeader({
  ...
  return (
    <div className="shrink-0">
      <header className="relative overflow-hidden rounded-xl border border-accent/15 bg-gradient-to-r from-surface from-[12%] to-accent-subtle px-5 py-4 shadow-[0_10px_28px_rgba(23,105,194,0.08)]">
        ...
        <div className="relative flex items-end justify-between gap-6">
          <div className="flex min-w-0 items-center gap-3.5">
            <span className="flex h-9 w-10 shrink-0 items-center border-r border-border pr-3 text-text">
